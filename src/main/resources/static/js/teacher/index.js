		...
		$.ajax({
			...
			success: function(data) {
				...
				$(selector).append("<div class='dropdown'>"
					...
					+ "<a class='dropdown-item' href='http://localhost:8080/teacher/profile'>Thông tin cá nhân</a>"
					+ "<a class='dropdown-item' href='http://localhost:8080/teacher/mycourse'>Khóa học của tôi</a>"
...
function register() {
	...
	$.ajax({
		url: "http://localhost:8080/api/teacher/register",
		type: 'POST',
		contentType: 'application/json',
		data: newdata,
		success: function(data) {
